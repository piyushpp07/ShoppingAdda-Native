...
export default function Profile() {
    ...
    return (
        <View style={{ marginTop: 10, justifyContent: 'center', alignItems: 'center' }}>
            <View style={{
                elevation: 10, width: '80%', height: '93%', backgroundColor: 'white', alignItems: 'center', padding: 50
            }}>
                ...
                <Text style={{ fontSize: 20, fontWeight: 'bold', top: 10 }}>Hello! {d}</Text>
                <Text style={{ fontSize: 15, fontWeight: 'bold', top: 10 }}> Orders :Rs{orderTotal}</Text>
                <Text style={{ fontSize: 15, fontWeight: 'bold', top: 10 }}> Cart Total :Rs{cartTotal}</Text>
                <Text style={{ fontSize: 15, fontWeight: 'bold', top: 10 }}> Wish Total :Rs{wishTotal}</Text>
