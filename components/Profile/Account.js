...
export default function Profile() {
    ...
    const [orderTotal, setOrderTotal] = ot;
    ...
    return (
        <View style={{ marginTop: 30, justifyContent: 'center', alignItems: 'center' }}>
            <View style={{
                ...
                <Text style={{ fontSize: 20, fontWeight: 'bold', top: 5 }}>Your Spendings : {orderTotal}</Text>
                <Text style={{ fontSize: 20, fontWeight: 'bold', top: 5 }}>Your Cart Total : {cartTotal}</Text>
                <Text style={{ fontSize: 20, fontWeight: 'bold', top: 5 }}>Your Wish Total : {wishTotal}</Text>
                <Button title="logout" mode='contained' style={{ color: 'green', width: "50%", top: 20 }} onPress={() => { Signout() }} >Signout</Button>
            </View>
        </View >
    )
}
